<script lang="ts">
	...
	import { wallets, type IWallet, reorderWallets, isHardwareWallet, isTrezorWallet } from '@/org.libersoft.wallet/scripts/crypto-utils/wallet';
	...
	import { isHwWalletActive } from '@/org.libersoft.wallet/scripts/crypto-utils/trezor';
