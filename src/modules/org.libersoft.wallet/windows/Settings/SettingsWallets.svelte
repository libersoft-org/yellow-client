<script lang="ts">
	...
	import { wallets, type IWallet, reorderWallets, isHardwareWallet, isTrezorWallet } from '@yellow-dev/crypto-utils/wallet';
	...
	import { isHwWalletActive } from '@yellow-dev/crypto-utils/trezor';
