<script lang="ts">
	...
	import { connectLedger, initializeLedger, ledgerLoading, ledgerError, ledgerConnected, ledgerDevice, ledgerConnectionMethod, ledgerDeviceId } from '@yellow-dev/crypto-utils/ledger';
