...
export let render_emojis_as_static = localStorageSharedStore('render_emojis_as_static', true);
...
//const emojiRegex = /rstenrsenirsiesrnientfrienpqwienqwienfeineethn/gu;
...
export async function init_emojis()
{
 ...
 cp = cp.sort((a, b) => b[0].length - a[0].length);
console.log(cp);
}*/
