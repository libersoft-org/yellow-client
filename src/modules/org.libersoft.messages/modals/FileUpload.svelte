...
<div class="file-upload {dropActive ? 'drop-active' : ''}">
	...
	<div class="header">
		<Button width="100%" img="img/add.svg" colorVariable="--color-default-foreground" text="Add files" onClick={onFileAdd} />
		<Button width="100%" img="img/del.svg" colorVariable="--color-default-foreground" text="Remove all" enabled={$fileUploadModalFiles.length > 0} onClick={onDeleteAll} />
	</div>
