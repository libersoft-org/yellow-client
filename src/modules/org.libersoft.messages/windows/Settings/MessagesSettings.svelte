<script lang="ts">
	...
	import { uploadChunkSize, hideMessageTextInNotifications, defaultFileDownloadFolder, messageListMaxWidth, messageListApplyMaxWidth, photoRadius } from '@/org.libersoft.messages/scripts/messages.ts';
