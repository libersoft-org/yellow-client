<script>
 ...
 function clickAddNotification() {
  ...
  const notificationData = {
   ...
   title: 'Very long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long title',
...
<div class="notifications-wrapper">
 ...
 <div class="notifications {direction && 'reverse'}">
  {#each $notifications.slice(-maxNotifications) as n}
   <Notification data={n} />
  {/each}
 </div>
</div>
