...
/* Identifiers come from the CSPRNG. Math.random() is neither collision-free nor unpredictable, and
 * crypto.getRandomValues() is available in insecure contexts too - unlike crypto.randomUUID(). */
