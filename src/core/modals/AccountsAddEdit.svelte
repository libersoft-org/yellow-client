...
<form class="form" onsubmit={onSubmit}>
 <div class="group">
  <Select label="{m['core.accounts_add_edit.protocol']()}:" bind:this={protocolElem} bind:value={protocol}>
   <SelectOption text="AMTP" value="amtp" selected={protocol === 'amtp'} />
   <SelectOption text="DMTP ({m['core.accounts_add_edit.not_yet_implemented']()})" value="dmtp" disabled={true} selected={protocol === 'dmtp'} />
  </Select>
 </div>
 <div class="group">
  <Input label="{m['core.accounts_add_edit.title']()}:" bind:value={config_title} />
 </div>
 <div class="group">
  <Input label="{m['core.accounts_add_edit.server']()}:" placeholder="wss://your_server/" bind:value={credentials_server} />
 </div>
 <div class="group">
  <Input label="{m['core.accounts_add_edit.address']()}:" grow placeholder="user@domain.tld" bind:value={credentials_address} />
 </div>
 <div class="group">
  <Input label="{m['core.accounts_add_edit.password']()}:" type="password" placeholder={m['core.accounts_add_edit.password_placeholder']()} bind:value={credentials_password} />
 </div>
