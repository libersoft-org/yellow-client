...
>
 ...
 {#if open}
  ...
  <ul bind:this={menuRef} role="menu" tabindex="-1" aria-label={ariaLabel} data-floating-menu-direction={direction} class:bx--overflow-menu-options={true} class:bx--overflow-menu--flip={flipped} class:bx--overflow-menu-options--open={open} class:bx--overflow-menu-options--light={light} class:bx--overflow-menu-options--sm={size === 'sm'} class:bx--overflow-menu-options--xl={size === 'xl'} class:bx--breadcrumb-menu-options={!!ctxBreadcrumbItem} class={menuOptionsClass}>
   <slot />
  </ul>
 {/if}
</button>
