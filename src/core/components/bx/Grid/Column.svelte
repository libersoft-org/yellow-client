<script>
 ...
 $: props = {
  ...$$restProps,
  class: [$$restProps.class, columnClass, !columnClass && 'bx--col', noGutter && 'bx--no-gutter', noGutterLeft && 'bx--no-gutter--left', noGutterRight && 'bx--no-gutter--right', aspectRatio && `bx--aspect-ratio bx--aspect-ratio--${aspectRatio}`, padding && 'bx--col-padding'].filter(Boolean).join(' '),
 };
</script>
