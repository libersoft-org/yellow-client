...
<div class:bx--form-item={true} {...$$restProps}>
 <div class:bx--select={true} class:bx--select--inline={inline} class:bx--select--light={light} class:bx--select--invalid={invalid} class:bx--select--disabled={disabled} class:bx--select--warning={warn}>
  {#if !noLabel}
  ...
  {#if inline}
   <div class:bx--select-input--inline__wrapper={true}>
    <div class:bx--select-input__wrapper={true} data-invalid={invalid || undefined}>
     <select bind:this={ref} aria-describedby={invalid ? errorId : undefined} aria-invalid={invalid || undefined} disabled={disabled || undefined} required={required || undefined} {id} {name} class:bx--select-input={true} class:bx--select-input--sm={size === 'sm'} class:bx--select-input--xl={size === 'xl'} on:change={handleChange} on:change on:input on:focus on:blur>
      <slot />
     </select>
  ...
  {#if !inline}
   <div class:bx--select-input__wrapper={true} data-invalid={invalid || undefined}>
    <select bind:this={ref} {id} {name} aria-describedby={invalid ? errorId : undefined} disabled={disabled || undefined} required={required || undefined} aria-invalid={invalid || undefined} class:bx--select-input={true} class:bx--select-input--sm={size === 'sm'} class:bx--select-input--xl={size === 'xl'} on:change={handleChange} on:change on:input on:focus on:blur>
     <slot />
    </select>
    <ChevronDown class="bx--select__arrow" />
    {#if invalid}
    ...
    {/if}
    {#if !invalid && warn}
     <WarningAltFilled class="bx--select__invalid-icon bx--select__invalid-icon--warning" />
    {/if}
   </div>
