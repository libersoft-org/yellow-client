...
<div class:bx--modal-footer={true} class:bx--modal-footer--three-button={secondaryButtons.length === 2} {...$$restProps}>
 ...
 {#if primaryButtonText}
  <Button kind={danger ? 'danger' : 'primary'} disabled={primaryButtonDisabled} class={primaryClass} icon={primaryButtonIcon} on:click={submit}>
   {primaryButtonText}
  </Button>
 {/if}
 <slot />
