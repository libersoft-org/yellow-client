 ...
 <ul class:bx--pagination-nav__list={true}>
  <li class:bx--pagination-nav__list-item={true}>
   <Button
    ...
    tooltipPosition={tooltipPosition === 'inside' ? 'right' : tooltipPosition === 'outside' ? 'left' : tooltipPosition}
  ...
  <li class:bx--pagination-nav__list-item={true}>
   <Button
    kind="ghost"
    tooltipAlignment="center"
    tooltipPosition={tooltipPosition === 'inside' ? 'left' : tooltipPosition === 'outside' ? 'right' : tooltipPosition}
