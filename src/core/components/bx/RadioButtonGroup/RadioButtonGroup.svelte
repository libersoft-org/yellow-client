...
<div {id} class:bx--form-item={true} {...$$restProps} on:click on:mouseover on:mouseenter on:mouseleave>
 <fieldset class:bx--radio-button-group={true} class:bx--radio-button-group--vertical={orientation === 'vertical'} class:bx--radio-button-group--label-left={labelPosition === 'left'} class:bx--radio-button-group--label-right={labelPosition === 'right'} {disabled}>
