...
<svelte:component this={icons[kind]} size={20} title={iconDescription} class="{notificationType === 'toast' && 'bx--toast-notification__icon'} {notificationType === 'inline' && 'bx--inline-notification__icon'}" />
