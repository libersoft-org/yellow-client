<script>
 ...
 const stepsById = derived(steps, steps => steps.reduce((a, c) => ({ ...a, [c.id]: c }), {}));
...
<ul class:bx--progress={true} class:bx--progress--vertical={vertical} class:bx--progress--space-equal={spaceEqually && !vertical} {...$$restProps} on:click on:mouseover on:mouseenter on:mouseleave>
 <slot />
</ul>
