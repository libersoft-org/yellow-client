...
<div class:bx--form-item={true} {...$$restProps} on:click on:mouseover on:mouseenter on:mouseleave>
 <div class:bx--date-picker={true} class:bx--skeleton={true} class:bx--date-picker--range={true} class:bx--date-picker--short={!range} class:bx--date-picker--simple={!range}>
