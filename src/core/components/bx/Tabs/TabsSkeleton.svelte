...
<div class:bx--tabs={true} class:bx--skeleton={true} class:bx--tabs--scrollable={true} class:bx--tabs--scrollable--container={type === 'container'} {...$$restProps} on:click on:mouseover on:mouseenter on:mouseleave>
