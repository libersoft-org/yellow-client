...
<div class:bx--form-item={true} {...$$restProps} on:click on:mouseover on:mouseenter on:mouseleave>
 <input type="checkbox" {id} class:bx--toggle={true} class:bx--toggle--small={size === 'sm'} class:bx--skeleton={true} />
 <label aria-label={labelText ? undefined : $$props['aria-label'] || 'Toggle is loading'} for={id} class:bx--toggle__label={true} class:bx--skeleton={true}>
