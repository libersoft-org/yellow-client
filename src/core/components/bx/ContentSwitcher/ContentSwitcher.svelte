...
<div role="tablist" class:bx--content-switcher={true} class:bx--content-switcher--sm={size === 'sm'} class:bx--content-switcher--xl={size === 'xl'} {...$$restProps} on:click on:mouseover on:mouseenter on:mouseleave>
 <slot />
</div>
