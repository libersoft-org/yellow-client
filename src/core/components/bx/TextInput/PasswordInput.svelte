...
<div class:bx--form-item={true} class:bx--text-input-wrapper={true} class:bx--password-input-wrapper={!isFluid} class:bx--text-input-wrapper--light={light} class:bx--text-input-wrapper--inline={inline} on:click on:mouseover on:mouseenter on:mouseleave>
 {#if inline}
 ...
 <div class:bx--text-input__field-outer-wrapper={true} class:bx--text-input__field-outer-wrapper--inline={inline}>
  <div class:bx--text-input__field-wrapper={true} class:bx--text-input__field-wrapper--warning={warn} data-invalid={invalid || undefined}>
   {#if invalid}
   ...
   <input
    ...
    aria-describedby={invalid ? errorId : warn ? warnId : helperText ? helperId : undefined}
    {id}
    {name}
    {placeholder}
    {type}
