...
{:else}
 ...
 <ul class:bx--accordion={true} class:bx--accordion--start={align === 'start'} class:bx--accordion--end={align === 'end'} class:bx--accordion--sm={size === 'sm'} class:bx--accordion--xl={size === 'xl'} {...$$restProps} on:click on:mouseover on:mouseenter on:mouseleave>
  <slot />
 </ul>
{/if}
