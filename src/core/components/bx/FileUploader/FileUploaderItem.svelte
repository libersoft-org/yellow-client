...
<span {id} class:bx--file__selected-file={true} class:bx--file__selected-file--invalid={invalid} class:bx--file__selected-file--md={size === 'field'} class:bx--file__selected-file--sm={size === 'small'} {...$$restProps} on:mouseover on:mouseenter on:mouseleave>
