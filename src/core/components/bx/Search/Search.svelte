...
{#if skeleton}
 <SearchSkeleton {size} {...$$restProps} on:click on:mouseover on:mouseenter on:mouseleave />
{:else}
 <div role="search" aria-labelledby="{id}-search" class:bx--search={true} class:bx--search--light={light} class:bx--search--disabled={disabled} class:bx--search--sm={size === 'sm'} class:bx--search--lg={size === 'lg'} class:bx--search--xl={size === 'xl'} class:bx--search--expandable={expandable} class:bx--search--expanded={expanded} class={searchClass}>
