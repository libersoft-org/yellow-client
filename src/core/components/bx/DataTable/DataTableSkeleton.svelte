 ...
 {#if showToolbar}
  <section aria-label="data table toolbar" class:bx--table-toolbar={true}>
   <div class:bx--toolbar-content={true}>
    <span class:bx--skeleton={true} class:bx--btn={true} class:bx--btn--sm={true}></span>
   </div>
  </section>
 {/if}
 <!-- svelte-ignore a11y-click-events-have-key-events -->
 <!-- svelte-ignore a11y-no-noninteractive-element-interactions -->
 <table class:bx--skeleton={true} class:bx--data-table={true} class:bx--data-table--compact={size === 'compact'} class:bx--data-table--short={size === 'short'} class:bx--data-table--tall={size === 'tall'} class:bx--data-table--zebra={zebra} on:click on:mouseover on:mouseenter on:mouseleave>
  <thead>
   <tr>
