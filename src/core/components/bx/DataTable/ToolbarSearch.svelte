<script>
 ...
 $: classes = [expanded && 'bx--toolbar-search-container-active', persistent ? 'bx--toolbar-search-container-persistent' : 'bx--toolbar-search-container-expandable', disabled && 'bx--toolbar-search-container-disabled'].filter(Boolean).join(' ');
</script>
