...
>
 {#if subOptions}
  <div class:bx--menu-option__content={true} class:bx--menu-option__content--disabled={disabled}>
   {#if indented}
  ...
  <ContextMenu open={submenuOpen} x={submenuPosition[0]} y={submenuPosition[1]}>
   <slot />
  </ContextMenu>
 {:else}
  <div class:bx--menu-option__content={true} class:bx--menu-option__content--disabled={disabled}>
